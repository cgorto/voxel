...
pub mod update_camera_data_reducer;
pub mod update_ray_reducer;
pub mod update_voxel_reducer;
pub mod voxel_entry_table;
pub mod voxel_entry_type;
pub mod voxel_grid_table;
pub mod voxel_grid_type;
pub mod voxel_type;

pub use camera_table::*;
pub use camera_type::Camera;
...
pub use update_camera_data_reducer::{
    set_flags_for_update_camera_data, update_camera_data, UpdateCameraDataCallbackId,
};
pub use update_ray_reducer::{set_flags_for_update_ray, update_ray, UpdateRayCallbackId};
pub use update_voxel_reducer::{set_flags_for_update_voxel, update_voxel, UpdateVoxelCallbackId};
pub use voxel_entry_table::*;
pub use voxel_entry_type::VoxelEntry;
pub use voxel_grid_table::*;
pub use voxel_grid_type::VoxelGrid;
pub use voxel_type::Voxel;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::UpdateCameraData { .. } => "update_camera_data",
            Reducer::UpdateRay { .. } => "update_ray",
            Reducer::UpdateVoxel { .. } => "update_voxel",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            ...
            .into()),
            "update_camera_data" => Ok(__sdk::parse_reducer_args::<
                update_camera_data_reducer::UpdateCameraDataArgs,
            >("update_camera_data", &value.args)?
            .into()),
            "update_ray" => Ok(
                __sdk::parse_reducer_args::<update_ray_reducer::UpdateRayArgs>(
                    "update_ray",
                    &value.args,
                )?
                .into(),
            ...
            "update_voxel" => Ok(
                __sdk::parse_reducer_args::<update_voxel_reducer::UpdateVoxelArgs>(
                    "update_voxel",
                    &value.args,
                )?
                .into(),
...
#[doc(hidden)]
pub struct DbUpdate {
    camera: __sdk::TableUpdate<Camera>,
    voxel_entry: __sdk::TableUpdate<VoxelEntry>,
    voxel_grid: __sdk::TableUpdate<VoxelGrid>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "camera" => db_update
                    .camera
                    .append(camera_table::parse_table_update(table_update)?),
                "voxel_entry" => db_update
                    .voxel_entry
                    .append(voxel_entry_table::parse_table_update(table_update)?),
                "voxel_grid" => db_update
                    .voxel_grid
                    .append(voxel_grid_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.camera = cache
            .apply_diff_to_table::<Camera>("camera", &self.camera)
            .with_updates_by_pk(|row| &row.identity);
        diff.voxel_entry = cache
            .apply_diff_to_table::<VoxelEntry>("voxel_entry", &self.voxel_entry)
            .with_updates_by_pk(|row| &row.id);
        diff.voxel_grid = cache
            .apply_diff_to_table::<VoxelGrid>("voxel_grid", &self.voxel_grid)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    camera: __sdk::TableAppliedDiff<'r, Camera>,
    voxel_entry: __sdk::TableAppliedDiff<'r, VoxelEntry>,
    voxel_grid: __sdk::TableAppliedDiff<'r, VoxelGrid>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Camera>("camera", &self.camera, event);
        callbacks.invoke_table_row_callbacks::<VoxelEntry>("voxel_entry", &self.voxel_entry, event);
        callbacks.invoke_table_row_callbacks::<VoxelGrid>("voxel_grid", &self.voxel_grid, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        camera_table::register_table(client_cache);
        voxel_entry_table::register_table(client_cache);
        voxel_grid_table::register_table(client_cache);
    }
}
